    ...
    loadSettings() {
        ...
        if (savedSettings) {
            try {
                ...
                console.warn('Invalid cometSettings JSON, resetting to defaults:', error);
                localStorage.removeItem('cometSettings');
            }
        }
    ...
    loadChatHistory() {
        ...
        if (savedHistory) {
            try {
                ...
                console.error('Failed to load chat history, clearing corrupted storage:', error);
                localStorage.removeItem('cometChatHistory');
                this.messages = [];
            }
        }
    }
